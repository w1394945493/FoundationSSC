...
metadata_root = "/c20250502/wangyushen/Datasets/kitti/metadata/foundationssc/kitti360"
...
# model
numC_Trans = 128  # context feature channels
...
model = dict(
    ...
    img_backbone=dict(
        ...
        ckpt_dir="/c20250502/wangyushen/Weights/foundationssc/23-51-11/model_best_bp2.pth",
        cfg_path="/c20250502/wangyushen/Weights/foundationssc/23-51-11/cfg.yaml",
    ),
    img_pre_neck=dict(
        type="SimpleFPN",
        backbone_channel=1024,  # vitl14
    ...
    depth_net=dict(
        ...
        cam_channels=33,  # mlp_input, cam channels
    ...
    dual_feature_fusion=dict(
        type="DualFeatFusion_Tri",
        input_channel=128,
        output_channel=128,
        norm_type="group",
    ),
